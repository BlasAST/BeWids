...
<div class="contenedor h-screen w-screen grid grid-cols-12 grid-rows-12">
    ...
    <div class="bg-green-700 row-[1/2] col-[10/13] h-[40%]">Salir sesion y Ajustes</div>
    ...
    <figure class=" btnCE row-[10/13] col-[1/2] w-[80%] h-[40%] self-center mb-5 justify-self-center">
        <img src="{{asset('imagenes/imagenesBasic/chat2.png')}}" alt="">
    </figure>
    <figure class=" btnCE2 row-[10/13] col-[2/3] w-[80%] h-[40%] self-center mb-5 justify-self-end">
